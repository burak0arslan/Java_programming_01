...
public class ComputerLab {
    public static void main(String[] args) {
        ...
        //System.out.println(Computer.brand); ***INVALID *** becaause we can not call instance variables within static methods (we are trying to access by the class name but we need an object)!!!
